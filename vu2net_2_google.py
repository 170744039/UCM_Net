...
class VGG19(nn.Module):
    def __init__(self):
        ...
        res1 = torchvision.models.googlenet(pretrained=True).conv1
        res2 = torchvision.models.googlenet(pretrained=True).maxpool1
        res3 = torchvision.models.googlenet(pretrained=True).conv2
        res4 = torchvision.models.googlenet(pretrained=True).conv3
        res5 = torchvision.models.googlenet(pretrained=True).maxpool2
        cnn_temp1 = torchvision.models.googlenet(pretrained=True).inception3a
        cnn_temp11 = torchvision.models.googlenet(pretrained=True).inception3b
        cnn_temp111 = torchvision.models.googlenet(pretrained=True).maxpool3
        cnn_temp2 = torchvision.models.googlenet(pretrained=True).inception4a
        cnn_temp2_0 = torchvision.models.googlenet(pretrained=True).inception4b
        cnn_temp2_1 = torchvision.models.googlenet(pretrained=True).inception4c
        cnn_temp2_2 = torchvision.models.googlenet(pretrained=True).inception4d
        cnn_temp2_3 = torchvision.models.googlenet(pretrained=True).inception4e




        self.layer1 = nn.Sequential(res1,res2)

        self.layer2 = nn.Sequential(res3,res4, res5)

        self.layer3 = nn.Sequential(cnn_temp1,cnn_temp11,cnn_temp111)

        self.layer4 = nn.Sequential(cnn_temp2,cnn_temp2_0,cnn_temp2_1,cnn_temp2_2,cnn_temp2_3)
