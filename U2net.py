...
class U2NET(nn.Module):
    ...
    def __init__(self,in_ch=3,out_ch=1):
        ...
        self.conv1 = nn.Conv2d(3, 10, kernel_size=(5, 5), padding=2)
        self.srm = SRMConv2D()
        self.bayer = BayarConv2D(3, 3, 5)
        ...
        # decoder
        self.stage5d = RSU4F(768,256,512)
        ...
        self.selfcorr = Self_Correlation_Per()
