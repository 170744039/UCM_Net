...
class VGG19(nn.Module):
    def __init__(self):
        ...
        cnn_temp = torchvision.models.densenet121(pretrained=True).features



        self.layer1 = nn.Sequential(cnn_temp[:6])

        self.layer2 = nn.Sequential(cnn_temp[6:8])

        self.layer3 = nn.Sequential(cnn_temp[8:10])

        self.layer4 = nn.Sequential(cnn_temp[10:])
        ...
        # self.corr1 = Self_Correlation_Per(nb_pools=32)
        # self.corr32 = Self_Correlation_Per(nb_pools=32)
        # # 32
        # self.corr64 = Self_Correlation_Per(nb_pools=512)
        # self.corr128 = Self_Correlation_Per(nb_pools=128)
        ...
        self.stage3d = RSU5(640, 320, 320)
        self.stage2d = RSU5(320, 64, 64)
        ...
        # 之后在这里做优化
        self.side1 = nn.Conv2d(320, 1, 3, padding=1)
        ...
        self.aspp3 = models.segmentation.deeplabv3.ASPP(in_channels=512,out_channels=512, atrous_rates=[4, 8, 12, 16])
        #
